...
const nodemail_adapter_1 = require("./adapters/nodemailer/nodemail-adapter");
...
exports.routes.post('/feedbacks', async (req, res) => {
    ...
    const nodeMailerAdapter = new nodemail_adapter_1.NodeMailAdapter();
    const submitFeedbackUseCase = new submit_feedback_use_case_1.SubmitFeedbackUseCase(prismaFeedbacksRepository, nodeMailerAdapter);
